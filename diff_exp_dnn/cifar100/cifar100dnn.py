...
import pickle
class cifar100net:
    def __init__(self,num_classes=100,minibatchsize=1,imagesize=32,dropout_keep_prob=1 ,scope='cifarnet' ,learningrate = 0.001,momentum = 0.5):
...
#            begin += 10
            ...
            para_fc3 = tf.get_variable('para_fc3',[128,128])
            para_fc3_bias = tf.get_variable('para_fc3_bias',[ 128])
            
            para_fc5 = tf.get_variable('para_fc5',[128,100])
            para_fc5_bias = tf.get_variable('para_fc5_bias',[ 100])
