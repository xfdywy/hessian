from cifar10dnn import cifar10net
import numpy as np
import matplotlib.pyplot as plt
import pickle
model   = cifar10net(minibatchsize=50, learningrate = 0.1)
...
all_res = {'info' : '_'.join(model.info.values()) ,
           'train_acc' :train_acc,
...
with open('./all_res/'+file_name+'.plk','wb') as f  :
    pickle.dump(all_res , f)
model.save_model('../modelsave/' ,file_name)        
#    model.fill_train_data()
#    model.eval_grad()
